...
public class MainFrame extends javax.swing.JFrame {
     ...
     */
    public static AdminMainScreen amd;
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1500, 1350));

        jSplitPane1.setPreferredSize(new java.awt.Dimension(1500, 1350));

        panelRight.setPreferredSize(new java.awt.Dimension(1200, 1350));
    ...
    private void btnAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminActionPerformed
        // TODO add your handling code here:
        CardLayout layout = (CardLayout)panelRight.getLayout();
        panelRight.add(amd=new AdminMainScreen(panelRight, (Admin)adminUser));
        layout.next(panelRight);
